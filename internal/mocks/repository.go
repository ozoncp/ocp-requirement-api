...
// Source: github.com/ozoncp/ocp-requirement-api/internal/repository (interfaces: Repo)
...
import (
	...
	models "github.com/ozoncp/ocp-requirement-api/internal/models"
)
...
func (m *MockRepo) AddEntities(arg0 []models.Requirement) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) AddEntity(arg0 models.Requirement) (uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(arg0 uint64) (*models.Requirement, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListEntities(arg0, arg1 uint64) ([]models.Requirement, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) RemoveEntity(arg0 uint64) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) UpdateEntity(arg0 models.Requirement) error {
	m.ctrl.T.Helper()
